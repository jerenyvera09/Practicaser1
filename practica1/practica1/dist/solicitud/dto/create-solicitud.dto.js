...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsDateString)({}, { message: 'La fecha debe tener formato válido (YYYY-MM-DD)' }),
    __metadata("design:type", String)
], CreateSolicitudDto.prototype, "fecha", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['pendiente', 'aprobada', 'rechazada'], {
